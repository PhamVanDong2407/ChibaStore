...
public class TinyDB {
    ...
    private SharedPreferences preferences; // dùng để lưu trữ và truy xuất dữ liệu dạng key-value
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY; // lưu trữ đường dẫn mặc định của thư mục chưa ảnh
    private String lastImagePath = ""; // lưu trữ đường dẫn ảnh cuối cùng được lưu trữ

    // Khởi tạo lớp TinyDB với tham số context và sử dụng nó để khởi tạo SharedPreferences
    public TinyDB(Context appContext) {
        preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
    }

    // Kiểm tra xem có external storage hay không
    public static boolean isExternalStorageWritable() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState());
    }

    // Kiểm tra xem có external storage có thể đọc hay không
    ...
    // Lấy đường dẫn ảnh cuối cùng được lưu
    public String getSavedImagePath() {
        return lastImagePath;
    }

    // Lưu ảnh vào thư mục mặc định của app
    ...
    // Lấy đường dẫn ảnh từ thư mục mặc định của app
